...
const LibraryMap: React.FC = () => {
  ...
  return (
    <div className="space-y-6 text-white bg-[#0a1111] p-4 lg:p-8 rounded-3xl shadow-xl border border-white/5">
      <h1 className="text-2xl lg:text-4xl font-bold mb-2">Library Floor Plan</h1>
      <p className="text-sm lg:text-base text-gray-400 mb-8">Find your way around the NEU University Main Library. Explore study zones, quiet areas, and collection stacks.</p>
